 ...
 * @param  {Object} data.name The name of the game being created.
 * @param  {Object} data.description The description of the game being created.
 * @param  {Object} data.installation The installation instructions of the game being created.
 * @return {Promise}
 */
 ...
 * @param  {Object} data.version The string representation of the version number.
 * @param  {Object} data.changelog The changelog of the new version being created.
 * @param  {Object} data.installation The installation instructions for new version being created.
 * @param  {Object} data.download The download link for the application compatible with this new version.
 * @return {Promise}
 */
