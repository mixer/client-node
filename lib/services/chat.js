 ...
 * @param  {Number} channelId
 * @param  {Object} data
 * @param  {Number} data.start The start of the time range to query for messages. Should be given as a unix timestamp with milliseconds.
 * @param  {Number} data.end The end of the time range to query for messages. Should be given as a unix timestamp with milliseconds.
 * @param  {Number} data.limit The maximum number of results to retrieve. If there are more results in the range than can be shown, the first limit messages from the end time will be displayed.
 * @return {Promise}
 */
 ...
 * @param {Number} channelID
 * @param {Object} data
 * @param {Boolean} data.linksAllowed Whether links are allowed to be posted in the chat.
 * @param {Boolean} data.linksClickable Whether links are allowed to be clicked from the chat.
 * @param {Number} data.slowchat The time interval, in seconds, that users have to wait between sending messages.
 */
