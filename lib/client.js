...
function Client () {
    ...
    for (var keys = Object.keys(Services), i = 0, length = keys.length; i < length; i++) {
        this[keys[i]] = new Services[keys[i]](this);
    }
}
...
/**
 * Builds a path to the Beam API by concatenating it with the address.
 * @private
 * @param  {String} base
 * @param  {String} path
